...
if (!class_exists('FLOWPLAYER6_VIDEO_PLAYER')) {
    ...
    class FLOWPLAYER6_VIDEO_PLAYER {
        ...
        {           
            $url = "http://wphowto.net/flowplayer-6-video-player-for-wordpress-813";
            $link_text = sprintf(wp_kses(__('Please visit the <a target="_blank" href="%s">Flowplayer 6 Video Player</a> documentation page for usage instructions.', 'flowplayer6-video-player'), array('a' => array('href' => array(), 'target' => array()))), esc_url($url));          
            echo '<div class="wrap">';               
            echo '<h2>Flowplayer 6 Video Player - v'.$this->plugin_version.'</h2>';
